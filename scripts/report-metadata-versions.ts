...
// const TYPE_VERSIONS = Vector(u32)

// const json = readFileSync('./pub/v2/chains/all.json', 'utf-8')
...
//     try {
//       const resVersions = await provider.send('state_call', ['Metadata_metadata_versions', ''], true)
//       const versions = TYPE_VERSIONS.dec(resVersions)
...
//       return [version]
//     } catch (error) {
//       console.log('error getting default metadata for chain', chain.id, chain.name, (error as any)?.message)
//     }
//   } finally {
//     provider.disconnect()
//   }
